        ...
        <div class="gradient">
            ...
            <div class="login"> 
                <form action="login.php" method="post">
                    <input id="loginInput" type="text" name="login" placeholder="Login" onfocus="this.placeholder=''" onblur="this.placeholder='Nickname'"></br>
                    ...
                    <input id="rePasswordInput" type="password" name="Re-enter" placeholder="Re-enter password" onfocus="this.placeholder=''" onblur="this.placeholder='Re-enter password'"></br>
